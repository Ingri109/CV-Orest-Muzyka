            ...
            <div ref={backdrop} onClick={onClick} className="fixed bg-black bg-opacity-70 backdrop-blur-sm top-0 left-0 flex items-center justify-center h-full w-full z-50">
                {nameModal === 'Your Love' &&
                    <div className="boxModalWorks animate-scaleIn border-[#BF2489] shadow-[#BF2489]">
                        <div className="basis-1/2 flex flex-col justify-start items-center justify-items-stretch mx-0 sm:mx-4">
                            <a target="blank" href="https://your-love-0-0-1.vercel.app/en" className="Sait bg-no-repeat bg-contain bg-top rounded-md aspect-[16/9] w-full mt-7 transition delay-200 duration-100 hover:scale-105 "></a>
                ...
                {nameModal === 'Coffee' &&
                    <div className="boxModalWorks  border-white shadow-color2_1">
                        <div className="basis-1/2 flex flex-col justify-start items-center justify-items-stretch mx-0 sm:mx-4">
                            <a target="blank" href="https://ingri109.github.io/Coffe_Zhenich/" className="Sait_Coffee bg-no-repeat bg-contain bg-top rounded-md aspect-[16/9] w-full mt-7 transition delay-200 duration-100 hover:scale-105"></a>
                ...
                {nameModal === 'CS' &&
                    <div className="boxModalWorks shadow-[0_0_40px_-10px_rgba(0, 0, 0, 0.3)] animate-scaleIn border-[#FBAC18] shadow-[#FBAC18]">
                        <div className="basis-1/2 flex flex-col justify-start items-center justify-items-stretch mx-0 sm:mx-4">
                            <a target="blank" href="https://ingri109.github.io/CS-First-Project/" className="Sait_CS bg-no-repeat bg-contain bg-top rounded-md aspect-[16/9] w-full mt-7 transition delay-200 duration-100 hover:scale-105"></a>
